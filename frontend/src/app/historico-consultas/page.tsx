...
export default function HistoricoConsultasPage() {
  ...
  useEffect(() => {
    axios.get('https://acupuntura-manager.onrender.com/api/pacientes')
  ...
  const buscarHistorico = async () => {
    ...
    setMensagem(null);
    try {
      const res = await axios.get(`https://acupuntura-manager.onrender.com/api/pacientes/${pacienteSelecionado}/historico`);
  ...
  const salvarRegistro = async (consultaId: number, texto: string) => {
    try {
      await axios.put(`https://acupuntura-manager.onrender.com/api/consultas/${consultaId}/registro`, {
  ...
  const registrarNovaConsulta = async () => {
    ...
    try {
      ...
      await axios.post(`https://acupuntura-manager.onrender.com/api/consultas`, novaConsulta);
